...
const GalleryPage: React.FC = () => {
  ...
  const sampleImages: CarData[] = [
    ...
    {
      id: "sample2",
      content: "Stanced NB Miata with aggressive fitment",
      idnumber: "2",
      src: [
        "/landingpagegallery/miata1.png",
        "/landingpagegallery/miata2.png",
      ...
      model: "NB Miata",
      chassis: "NB",
      description: "Stanced NB Miata with aggressive fitment and wide wheels",
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    },
    {
      id: "sample3",
      content: "Street-focused NC Miata with balanced setup",
      idnumber: "3",
      src: [
        "/landingpagegallery/miata1.png",
        "/landingpagegallery/miata2.png",
      ...
      model: "NC Miata",
      chassis: "NC",
      description: "Street-focused NC Miata with balanced wheel and tire setup",
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    },
    {
      id: "sample4",
      content: "Track-ready ND Miata with wide sticky tires",
      idnumber: "4",
      src: [
        "/landingpagegallery/miata1.png",
        "/landingpagegallery/miata2.png",
      ...
      chassis: "ND",
      description:
        "Track-ready ND Miata with wide sticky tires and aggressive alignment",
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    },
    {
      id: "sample5",
      content: "Classic NA Miata with period-correct wheels",
      idnumber: "5",
      src: [
        "/landingpagegallery/miata1.png",
        "/landingpagegallery/miata2.png",
      ...
      model: "NA Miata",
      chassis: "NA",
      description: "Classic NA Miata with period-correct wheels and tires",
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    },
    {
      id: "sample6",
      content: "Show car NB Miata with custom wheels",
      idnumber: "6",
      src: [
        "/landingpagegallery/miata1.png",
        "/landingpagegallery/miata2.png",
      ...
      model: "NB Miata",
      chassis: "NB",
      description: "Show car NB Miata with custom wheels and stretched tires",
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    },
    {
      id: "sample7",
      content: "Autocross NC Miata with lightweight setup",
      idnumber: "7",
      src: [
        "/landingpagegallery/miata1.png",
        "/landingpagegallery/miata2.png",
      ...
      chassis: "NC",
      description:
        "Autocross NC Miata with lightweight wheels and wide sticky tires",
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    },
    {
      id: "sample8",
      content: "Daily driver ND Miata with all-season tires",
      idnumber: "8",
      src: [
        "/landingpagegallery/miata1.png",
        "/landingpagegallery/miata2.png",
      ...
      model: "ND Miata",
      chassis: "ND",
      description: "Daily driver ND Miata with comfortable all-season tires",
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    },
    {
      id: "sample9",
      content: "Time attack NA Miata with extreme aero",
      idnumber: "9",
      src: [
        "/landingpagegallery/miata1.png",
        "/landingpagegallery/miata2.png",
      ...
      chassis: "NA",
      description:
        "Time attack NA Miata with extreme aero and wide track setup",
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    },
  ];
